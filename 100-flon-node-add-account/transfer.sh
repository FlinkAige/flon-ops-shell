...
tcli system newaccount flon $acc FO8ixPk3x4wZQu1bwBtw67JznFr5LVcA9bfDpkS7grnms3JNm7Qq  --transfer-quant "10.000000 FLON" -p flon
sleep 3
random_string=$(cat /dev/urandom | tr -dc '1-9' | fold -w 3 | head -n 1)
result=$(echo "scale=2; $random_string / 100" | bc)

focli transfer flon $acc "${result} FLON"